...
1. download all the code from my github and follow the insruction of [jwyang](https://github.com/jwyang/faster-rcnn.pytorch/tree/pytorch-1.0) below to setup the environment and download pretrained models(vgg16 or/and resnet101) to ./data/pretrained_model. Install cocoapi following [this guide](https://github.com/jwyang/faster-rcnn.pytorch/issues/410), or comment every lines about coco dataset if you encountered any error.
